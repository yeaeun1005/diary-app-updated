...
const release='credits-registration-20260923';
...
if(process.argv[2]==='--one'){
 ...
 let code=fs.readFileSync(file,'utf8').replace(/renders\/releases\/(review-polish-20260922|diary-board-fixes-20260921|student-refinements-20260921|classroom-controls-20260920)\//g,out);
 ...
 const logDir='renders/submission-audit-20260923';fs.mkdirSync(logDir,{recursive:true});
