...
root = Path(__file__).resolve().parents[4] / 'renders/releases/credits-registration-20260923/memory-preview'
...
print('Safe memory preview: http://127.0.0.1:8797/', flush=True)
