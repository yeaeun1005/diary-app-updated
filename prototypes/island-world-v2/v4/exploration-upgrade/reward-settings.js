...
function V4RewardSettingsPanel({user,students,onSaved}){
 ...
 return v4h('section',{className:'v4-reward-settings','aria-label':'탐험 보상 난이도'},v4h('small',null,'우리 반 활동 설정'),v4h('h2',null,'탐험 보상 난이도'),groups.length?v4h(React.Fragment,null,
