...
function v4IslandTutorialSteps(){
 ...
 return [
  ...
  {id:'activities',target:target('.v4-tools button:first-child'),title:'다섯 곳의 마음 활동',text:'책에서 일기를 쓰고, 망원경에서 마음을 살펴봐요. 조개는 마음 대화, 나침반은 연습, 보물함은 지난 일기예요. **마음 활동에서 바로 열 수도 있어요.**',next:'button',inert:true,pad:8},
