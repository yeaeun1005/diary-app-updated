> 최신 후속 게시: [학생 활동·꾸미기 배포 기록](DECOR_DEPLOYMENT.md). 최신 후보는 `prepare-decor.py`와 `mind-island-v4-decor-20260919` 인자를 사용합니다. 아래 초기 V4 생성 절차는 당시 게시 기록이며 현재 작업에 재실행하지 않습니다.
