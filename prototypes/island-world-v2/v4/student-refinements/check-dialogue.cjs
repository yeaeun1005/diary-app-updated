...
const html=fs.readFileSync('renders/releases/student-refinements-20260921/candidate/index.html','utf8'),out='renders/releases/student-refinements-20260921/',m=JSON.parse(fs.readFileSync(out+'manifest.json')),src=out+'candidate/'+m.assetPath+'/';
