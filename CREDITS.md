...
DESIGN §4 "참고와 모방의 선"에 따라, 외부에서 가져온 자료는 여기에 적는다. 음원은 `sounds/CREDITS.md`.
...
| Jua · Gowun Dodum | 우아한형제들 · 고운 | 그 밖의 화면(일기·대시보드 등) | SIL Open Font License 1.1. Google Fonts에서 불러온다 | (외부) |
