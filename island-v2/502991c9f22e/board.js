...
function V2Board({ me, myState, arrive, backLabel, onBack, onSeen, onTour, tutOn }) {
  ...
  // ── 카드 ──
  var lab = { HA: "활기", LA: "평온", LV: "슬픔", HV: "떨림" };
  var pill = function (q2) { return React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#5b7684", border: "1px solid #c9d8de", borderRadius: 6, padding: "1px 6px", marginLeft: 6 } }, lab[q2] || ""); };
  ...
  async function save() {
    ...
    try {
      ...
      setAns({ sid: String(me.id), o: o, f: f, w: w, fl: form.fl.slice(), ts: nowTs(), s: flagged ? 2 : 0, nmf: flagged });
  ...
  var row = function (name, body) {
    return React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "flex-start", marginTop: 6 } },
      ...
      React.createElement("div", { style: { flex: 1, fontSize: 14, color: "#28444f", lineHeight: 1.6, whiteSpace: "pre-wrap", wordBreak: "break-word" } }, body));
  };
  ...
  var ansBody = function (a) {
    return React.createElement("div", null,
      React.createElement("div", { style: { fontSize: 14, color: "#28444f", lineHeight: 1.6, whiteSpace: "pre-wrap", wordBreak: "break-word", marginTop: 4 } }, plazaAnsText(a) || "—"),
  ...
  var tipEl = tip ? React.createElement("div", { style: { marginTop: 8, fontSize: 13, color: "#3f5560", background: QB[tip.q] || "#f4f8fa", borderRadius: 10, padding: "7px 11px", lineHeight: 1.6 } },
    React.createElement("b", { style: { color: QC[tip.q] || "#0e7490" } }, tip.l), pill(tip.q), " ",
  ...
  if (loading) body = React.createElement("div", { style: { fontSize: 14, color: "#5b7684" } }, "오늘의 질문을 가져오는 중…");
    ...
    q.nm ? React.createElement("div", { style: { fontSize: 12, color: "#9a5b2b", background: "#fff4e6", borderRadius: 8, padding: "5px 10px", marginBottom: 6 } }, "친구 이름은 쓰지 않아요. '어떤 친구가'라고 써요.") : null,
    // 2026-09-16 개편: 관찰·느낌·바람 세 칸 → 답 한 칸(자유롭게) + 마음 말 칩(선택). 이름 검사·교사 승인은 그대로
    React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "#0e7490", marginTop: 6 } }, "내 답 · 있었던 일과 그때 마음을 자유롭게 써요"),
    ...
    React.createElement("div", { style: { fontSize: 13, fontWeight: 700, color: "#0e7490", marginTop: 8 } }, "그때 마음 말",
      React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#6b8792", marginLeft: 6 } }, "골라도 좋아요 · 다섯 개까지")),
    ...
    !ans ? React.createElement("div", null,
      React.createElement("div", { "data-tut": "plz-how", style: { display: "flex", alignItems: "center", gap: 10, marginTop: 12, flexWrap: "wrap" } },
        React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: "#3a5561" } }, "있었던 일과 그때 마음을 자유롭게 써요."),   // 2026-09-16: 세 칸 안내 → 한 칸
    ...
    : React.createElement("div", null,
      ...
      React.createElement("div", { "data-tut": "plz-mine", style: { background: "#f7fbfc", border: "1px solid #dfeaee", borderRadius: 12, padding: "8px 12px 10px", marginTop: 10 } },
        React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" } },
          ...
          : ans.s === 0 ? React.createElement("span", {style:{fontSize:12,color:"#6d786b"}}, "선생님의 공개를 기다려요") : ans.s === 1 ? React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: "#0e7490" } }, "게시판에 공개됐어요") : null,
      ...
      pub.length ? pub.filter(function (p2) { return !p2.mine; }).map(function (p2, i) { return React.createElement(React.Fragment, { key: i }, ansCard(p2, false)); })
        : React.createElement("div", { style: { fontSize: 13, fontWeight: 600, color: "#5b7684", marginTop: 6, lineHeight: 1.6 } }, "선생님이 고른 답이 3개 이상 모이면 이름 없이 여기에 보여요.")),
    legendEl);
