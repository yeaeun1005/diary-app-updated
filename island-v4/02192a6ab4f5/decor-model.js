...
const V4Decor=(()=>{
 const items={
  ...
  swing:{name:'별빛 그네',icon:'☆',desc:'살랑이는 바람과 쉬어 가는 자리',width:2.3,r:1.46,color:'#e8c886'},
  lighthouse:{name:'작은 등대',icon:'♜',desc:'마음 바다를 밝히는 포근한 불빛',height:2.4,r:1.10,color:'#e4a99b'},
  flowerBoat:{name:'꽃배 화분',icon:'❀',desc:'작은 나무배에 가득 핀 꽃',width:2.1,r:1.20,color:'#d9b17d'}
 };
 ...
 const obstacles=[[-6.2,-5.3,.4],[3,-9,.65],[-9,-7,.48],[-12,-2,.4],[-6,-10,.4],[9,-10,.4],[14,4,.35],[-16,3,.48],[-14,-8,.45],[-9,11,.4],[17,-8,.45],[17,6,.43],[3,-6.5,1.45],[-8,-5.3,1.15],[-10,5.5,1],[6.2,-5,.74],[-3.8,8.7,1.3],[-5,-2,.45],[7,5,.45],[-5,6,.45],[5,-5,.45]].map(([x,z,r])=>({x,z,r}));
