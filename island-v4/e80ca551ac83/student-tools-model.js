...
const V4StudentTools=(()=>{
 ...
 function prepare(text,emotions,situations,date,ts){
  ...
  return {ts,date,text:composed.text,analysis:{...analysis,automaticText:text.trim()?text:'',studentSelection:composed.labels}};
 }
 function refresh(entries){
  return entries.map(e=>{
   ...
   return {...e,analysis:{...a,...fresh,studentSelection:a.studentSelection||[]}};
  });
 }
 ...
 return {detected,compose,prepare,refresh,summarize,actionExamples,talkSeed,talkSteps,reflections};
})();
