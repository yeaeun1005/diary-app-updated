...
function V4ActivityGuide({me,kind}){
 ...
 useEffect(()=>{let seen=false;try{seen=localStorage.getItem(key)==='1';}catch{}if(seen)return;const t=setTimeout(begin,500);return()=>clearTimeout(t);},[key]);
