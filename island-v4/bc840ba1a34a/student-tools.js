...
function V4AnalysisTools({entries}){
 const [period,setPeriod]=useState('all'),[scope,setScope]=useState('all'),[start,setStart]=useState(''),[end,setEnd]=useState(''),[hover,setHover]=useState(null),[focus,setFocus]=useState(null);
